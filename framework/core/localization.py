...
class Localization(Singleton):
    ...
    strings = dict()
    languages = {'vi', 'en'}
    strings = {'vi': {'all_settings': 'Cài đặt', 'all_back': 'Quay lại', 'setting_audio_toggle': 'Hiệu ứng âm thanh', 'setting_music_toggle': 'Âm nhạc', 'setting_language': 'Ngôn ngữ', 'setting_language_en': 'Tiếng Anh', 'setting_language_vi': 'Tiếng Việt', 'continue_button': 'Tiếp tục', 'restart_button': 'Làm mới', 'menu_button': 'Menu', 'setting_button': 'Cài đặt', 'start_button': 'Bắt đầu', 'about_button': 'Giới thiệu', 'lose_message_1': 'Bạn đã thua!', 'lose_message_2': 'Nhấn phím bất kì để chơi lại', 'lose_message_3': 'Nhấn ESC để trở về màn hình chính'}, 'en': {'all_settings': 'Settings', 'all_back': 'Back', 'setting_audio_toggle': 'Audio Effects', 'setting_music_toggle': 'Music', 'setting_language': 'Language', 'setting_language_en': 'English', 'setting_language_vi': 'Vietnamese', 'continue_button': 'Continue', 'restart_button': 'Restart', 'menu_button': 'Menu', 'setting_button': 'Setting', 'start_button': 'Start', 'about_button': 'About', 'lose_message_1': 'You lose!', 'lose_message_2': 'Press any key to play again', 'lose_message_3': 'Press ESC to go back to menu'}}
